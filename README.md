...
e.g., dma -o test.test -fspta ~/test_bc/sefuzz-zlib/sefuzz-minigzip.bc
new. dma_wrapper.py -ander -savior-label-only -o tcpdump.reach -edge tcpdump.edge muse-tcpdump.bc
